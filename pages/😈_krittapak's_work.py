...
def fixname(index, variable, key):
    cols = st.columns(2)
    with cols[0]:
        st.markdown(f"## {index-3}. {name_list[index]}")
    if name_list[index] == "":
...
def krittapak():
    ...
    text1 = None
    fixname(4, variable=text1, key="1")

    link1 = None
    fixlink(20, link1, key="l1")
    
    link2 = None
    fixlink(11, link2, key="l2")

    link3 = None
    fixlink(22, link3, key="l3")

    link4 = None
    fixlink(23, link4, key="l4")

    link5 = None
    fixlink(24, link5, key="l5")
    st.text(" ")
    st.text(" ")

##########################
    text2 = None
    fixname(5, variable=text2, key=2)

    link6 = None
    fixlink(25, link6, key="l6")
    
    link7 = None
    fixlink(26, link7, key="l7")

    link8 = None
    fixlink(27, link8, key="l8")

    link9 = None
    fixlink(28, link9, key="l9")

    link10 = None
    fixlink(29, link10, key="l10")
